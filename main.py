...
def set_game_colors():
    global othello_color, light_button_color, background_color, play_text_color, board_color, dark_button_color, setting_label_color, bubble_color
...
while True:
    ...
    if game_active:
        ...
        if settings_open:
            ...
            image = pg.image.load('Photos\Othello.jpg')
    ...
    icon = pg.image.load('./Photos/Othello.jpg')
